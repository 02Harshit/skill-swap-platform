          ...
          <div className={styles.desktopMenu}>
            {user ? (
              <>
                ...
                <button onClick={logout} className={`${styles.btn} ${styles.logoutBtn}`}>
                  Logout
                </button>
              </>
            ) : (
              <button onClick={handleLoginRedirect} className={`${styles.btn} ${styles.loginBtn}`}>
                Login
              </button>
            )}
          </div>
          ...
          <div className={styles.mobileMenuContent}>
            {user ? (
              <>
                ...
                <button onClick={logout} className={`${styles.btn} ${styles.mobileLogoutBtn}`}>
                  Logout
                </button>
              </>
            ) : (
              <button onClick={handleLoginRedirect} className={`${styles.btn} ${styles.mobileLoginBtn}`}>
                Login
              </button>
            )}
          </div>
